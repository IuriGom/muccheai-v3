...
On first setup, the wizard creates a user called **`admin`** whose password is your **legacy API key**.
...
│   ├── web/                 # Axum server
│   │   ├── mod.rs           # Core types, handlers, chat pipeline
│   │   ├── middleware.rs    # Auth + rate-limit middleware
│   │   ├── router.rs        # Route table and CORS/security layers
...
│   ├── style/               # Terminal theming
│   │   ├── mod.rs           # Module root and re-exports
│   │   ├── theme.rs         # Color palette definitions
│   │   ├── risk.rs          # Risk-level styling helpers
│   │   ├── progress.rs      # Spinner / progress UX
│   │   ├── easter_eggs.rs   # Persona-driven Easter-egg strings
│   │   └── words.rs         # Animated thinking phrases
