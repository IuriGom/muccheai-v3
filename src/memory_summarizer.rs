//! Automatic memory summarizer for long chat sessions.
...
pub fn summarize(session: &ChatSession) -> String {
    ...
    // Naive topic extraction: first few user messages.
    ...
    // Naive decision extraction: look for decision-like keywords in AI replies.
