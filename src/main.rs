...
fn run_demo() {
    ...
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║  MuccheAI v3.2 — Security-Focused AI Agent                  ║");
    println!("║  Defense-in-depth architecture                               ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
    ...
    println!("  ⚠ Warrant canary: not configured (no maintainer signatures)");
    ...
    println!("  ✓ Inference time: 42 ms (simulated)");
    ...
    // Step 10: Cross-agent delegation
    ...
    println!("  ⚠ Build verification: not configured (no CI systems linked)");
    println!("  ⚠ Warrant canary: not configured (no maintainer signatures)");
    println!("═══════════════════════════════════════════════════════════════");
    println!("\nMuccheAI v3.2 initialized successfully.");
...
fn verify_build() -> anyhow::Result<String> {
    ...
    report.push_str("  ⚠ Warrant canary: not configured (no maintainer signatures)\n");
